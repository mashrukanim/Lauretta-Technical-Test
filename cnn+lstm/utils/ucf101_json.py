...
if __name__ == '__main__':
    ...
    for split_index in range(1, 2):
        ...
        train_csv_path = os.path.join(csv_dir_path, 'trainlist01.txt'.format(split_index))
        val_csv_path = os.path.join(csv_dir_path, 'testlist01.txt'.format(split_index))
        dst_json_path = os.path.join(csv_dir_path, 'ucf101_01.json'.format(split_index))
